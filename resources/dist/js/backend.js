    ...
    $.Redactor.prototype.source = function() {
        ...
        return {
            init: function() {
                ...
                let button = this.button.addFirst('html', 'HTML');
            ...
            setCaretOnShow: function() {
                ...
                let $editorDiv = $("<div/>").append($.parseHTML(this.core.editor().html(), document, true));

                let $selectionMarkers = $editorDiv.find("span.redactor-selection-marker");

                if ($selectionMarkers.length > 0) {

                    let editorHtml = $editorDiv.html().replace(/&amp;/g, '&');
            ...
            setCaretOnHide: function(html) {
                ...
                if (this.source.start > this.source.end && this.source.end > 0) {
                    ...
                    let tempStart = this.source.end;
                    let tempEnd = this.source.start;
                ...
                if (this.source.end > this.source.start) {
                    ...
                    let markerLength = this.marker.html(1).toString().length;
            ...
            hide: function() {
                ...
                let code = this.source.$textarea.val();
            ...
            show: function() {
                ...
                let height = this.core.editor().innerHeight();
            ...
            enlargeOffset: function(html, offset) {
                ...
                if (html[offset] === '>') {
                    ...
                    for(let i = offset; i <= htmlLength; i++) {
