    ...
    public function getIndex($group = null)
    {
        ...
        foreach($allTranslations as $translation){
         ...
         return view('admin.manager::index')
            ...
            ->with('editUrl', $group ? action('\Workhouse\Multilanguage\Controllers\Admin\ManagerController@postEdit', [$group]) : null)
