...
/**
 * Class WebRepository
 * @package Workhouse\Core\Repositories
 */
...
class WebRepository {
	...
	public function __construct() {
		...
		$repository = Str::replaceLast('Controllers', 'Repository', Str::replaceLast('\\', '\\Repositories\\', $c));


		//if($model){
		//if(class_exists($repository)){

			$this->repository = class_exists($repository) ? new $repository() : ($model ? new GeneralFrontendRepository($model) : null);
		//}
	...
	public function generateResponse($type, $data){
